...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY SULA-MD 🤍*",
...
MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/ral6cu.jpg",
// add custom menu and mention reply image url
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "SULA-X-BOT",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "SULA MD",
...
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/ral6cu.jpg",
